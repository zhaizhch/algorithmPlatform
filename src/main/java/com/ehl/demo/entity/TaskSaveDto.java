...
public class TaskSaveDto {
    ...
    @NotEmpty(message = "taskName不能为空", groups = {TaskSaveDto.saveGroup.class})
    private String taskName;
    private String namespace;
    private Integer replicas;
    private String createUserId;
    @NotEmpty(message = "taskType不能为空", groups = {TaskSaveDto.saveGroup.class})
    ...
    @NotEmpty(message = "imageName不能为空", groups = {TaskSaveDto.saveGroup.class})
